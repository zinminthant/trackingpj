    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress"> \
                  <div class="progress-bar progress-bar-striped bg-dark countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;background-color: #000000"> \
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  ...
                  <div class="modal-footer"> \
                    ...
                    <button id="session-timeout-dialog-keepalive" type="button" class="btn btn-dark" data-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
