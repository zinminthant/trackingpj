...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        <%--<nav class="navbar navbar-expand-lg main-navbar" style="  box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1);height: 60px;">--%>
            <%--<a href="index.html" class="navbar-brand sidebar-gone-hide" style="padding-left: 200px;display: none"><img src="/assets/img/tracking.png" width="60px"> </a>--%>

            <%--<form class="form-inline ml-auto" >--%>

            <%--</form>--%>
            <%--<ul class="navbar-nav navbar-right" style="padding-right: 80%">--%>

                    <%--<a href="#"  class="nav-link dropdown-toggle nav-link-lg" id="small-icon">--%>
                    <%--<img src="/assets/img/tracking.png" width="60px">--%>
                    <%--</a>--%>
            ...
            <section class="section">
                ...
                <div class="section-body">
                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-sm-7 col-lg-7" style="text-align: left">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <address>
                                                                    <strong>Delivery Info:</strong><br><br>
                                                                    U Mg Mg<br>
                                                                    09773453456<br>
                                                                    Yangon<br>
